 ...
 *
 * <p>ClickHouse has no separate default-value clause to add; the whole column is redeclared with
 * {@code DEFAULT}. The column is made nullable at the same time, matching the other ClickHouse
 * generators that redeclare a column's type.
 */
